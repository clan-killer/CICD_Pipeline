...
GIT_REPO_URL="https://github.com/bpechetti/CICD_Pipeline.git"  # Replace with your Git repository URL
WEB_ROOT="/var/www/html/CICD_Pipeline"  # Replace with the path to your web application's root directory
